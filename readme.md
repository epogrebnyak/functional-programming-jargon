...
- Несколько статей я выбросил из перевода или сильно сократил, поскольку они, похоже, интересны только со стороны JavaScript. То же самое, но в еще большем масштабе, делали 
авторы турекой версии перевода.
