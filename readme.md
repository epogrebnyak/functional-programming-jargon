...
с примерами на Нaskell. Оригинальная статья использует примеры на JavaScript, она переведена на русский [здесь](https://habr.com/ru/post/310172). Комментарии переводчика приведены 
[тут](translation.md).

[en]: https://github.com/hemanth/functional-programming-jargon
[tr]: https://github.com/mrtkp9993/functional-programming-jargon

__Словарь сленга функционального программирования__
